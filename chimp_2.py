...
data_dir = os.path.join(main_dir, r'/home/dario/Desktop/TAREAS')
...
class Fist(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image, self.rect = load_image('chocolate.png', -1)
        self.punching = 0
...
class Chimp(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image, self.rect = load_image('amlo.png', -1)
    ...
    def _walk(self):
        "move the monkey across the screen, and turn at the edges"
        newpos = self.rect.move(self.move)

    # Rebotar si choca con los bordes
...
#Prepare Game Objects
    ...
    whiff_sound = pygame.mixer.Sound('fuchi.wav')
    punch_sound = pygame.mixer.Sound('cacahuate.wav')
    #
